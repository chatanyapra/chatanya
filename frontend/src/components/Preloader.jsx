...
import './Preloader.css'; // Assuming you will create this CSS file
...
const Preloader = () => {
    useEffect(() => {
        ...
        tl.to("body", { overflow: "hidden" })
            .to(".preloader .text-container", { duration: 0, visibility: "visible", ease: "Power3.easeOut" })
            .from(".preloader .text-container h1", {
                duration: 0.9, // Reduced duration
                delay: 0.9, // Adjusted delay for synchronization
                y: 70,
                skewY: 10,
                stagger: 0.2, // Adjusted stagger timing
                ease: "Power3.easeOut"
            })
            .to(".preloader .text-container h1", {
                ...
                y: 70,
                skewY: -20,
                stagger: 0.1, // Adjusted stagger timing
                ease: "Power3.easeOut"
            })
            .to(".preloader", { duration: 0.9, height: "0vh", ease: "Power3.easeOut" })
            .to("body", { overflow: "auto" }, "3.2")
